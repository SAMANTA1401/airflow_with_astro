...
with DAG(dag_id='weather_etl_pipeline',
    ...
    def extract_weather_data():
        """
        Extracts weather data from the Open Meteo API for the specified location (London) using Airflow Connection..
        """
        # use HTTP Hook to get connection details from Airflow Connection
        api_hook = HttpHook(http_conn_id=API_CONN_ID, method='GET')
        #Build the API endpoint
        # endpoint = "http://api.open-meteo.com/v1/forecast?latitude={51.5074}&longitude={}&current_weather=true"
    ...
    def transform_weather_data(weather_data):
        """
        Transforms the extracted weather data by extracting the relevant fields.
        """
